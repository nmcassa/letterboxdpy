...
class Watchlist:
    ...
    def get_owner(self) -> str:
        return self.pages.watchlist.get_owner()

    def get_url(self) -> str:
        return self.pages.watchlist.url
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--user", "-u", help="Username to fetch watchlist for", required=False
    )
    ...
    try:
        ...
        print("Error: User's watchlist is private.")
