...
class List:
    ...
    def __getattr__(self, name):
        ...
        if callable(method):
            ...
            raise TypeError(
                f"'{self.__class__.__name__}' object attribute '{name}' is not callable"
            )
    ...
    def get_url(self) -> str:
        return self.pages.list.url

    def get_title(self) -> str:
        return self.pages.list.get_title()

    def get_author(self) -> str:
        return self.pages.list.get_author()

    def get_description(self) -> str:
        return self.pages.list.get_description()

    def get_date_created(self) -> list:
        return self.pages.list.get_date_created()

    def get_date_updated(self) -> list:
        return self.pages.list.get_date_updated()

    def get_tags(self) -> list:
        return self.pages.list.get_tags()

    def get_movies(self) -> dict:
        return self.pages.list.get_movies()

    def get_count(self) -> int:
        return self.pages.list.get_count()

    def get_list_id(self) -> str:
        return self.pages.list.get_list_id()

    def get_list_meta(self, url: str) -> ListMetaData:
        return self.pages.list.get_list_meta(url)
